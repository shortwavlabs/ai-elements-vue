...
<template>
  <pre class="bg-muted p-4 flex items-center">
<div v-if="showLineNumbers" class="text-right pr-4 opacity-50 select-none text-[13px] leading-5 flex flex-col items-center text-muted-foreground">
